...
Public Class FormReportPriceAnalisysArg
    ...
    Public Sub New(ByVal partida_id As Int32, Optional ByVal obra_id As Int32 = -1)
        ...
        AddHandler CommonFuntion.EvInsertRecord, AddressOf OnEvReLoadForCrud ' hoy para todo slos formularios de reportes
    ...
    Public Sub RefreshReportPriceAnalysis(Optional ByVal partida_id As Int32 = -1, Optional ByVal obra_id As Int32 = -1)
        ...
        Dim _DataTablePartidaEquipmentArg As DataTable = Nothing '31/12
        Dim _DataTablePartidaEquipmentTotalArg As DataTable = Nothing '31/12

        Dim _DataTablePartidaCostsEquitmentTbArg As DataTable = Nothing
        Dim _DataTablePartidaCostsEquitmentTotalArg As DataTable = Nothing

        Dim _DataTbleTotalRublos As DataTable = Nothing
        ...
        If _partida_id > 0 Then
            ...
            _DataTablePartidaEquipmentArg = GetPartidaEquipmentArg(_partida_id, _ReferenceDate, _moneyType_Id)
            _DataTablePartidaEquipmentTotalArg = GetPartidaEquipmentTotalArg(_partida_id, _ReferenceDate, _moneyType_Id)
            _DataTablePartidaCostsEquitmentTbArg = GetPartidaCostsEquitmentTbArg(_partida_id, _ReferenceDate, _moneyType_Id, _obra_id)
            _DataTablePartidaCostsEquitmentTotalArg = GetPartidaCostsEquitmentTotalArg(_partida_id, _ReferenceDate, _moneyType_Id, _obra_id)

        End If

        ''Test~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        'Dim _Form1 As New Form1(_DataTablePartidaCostsEquitmentTotalArg)
        '_Form1.ShowDialog()

        ''Test~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        'Dim _Form1 As New Form1(_DataTablePartidaEquipmentArg)
        '_Form1.ShowDialog()

        ''Test~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ' Dim _Form1 As New Form1(_DataTablePartidaCostsEquitmentTbArg)
        ' _Form1.ShowDialog()

        'Dim _Form2 As New Form1(_DataTableMat)
        '_Form2.ShowDialog()
        '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

        'Test~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        'Dim _Form1 As New Form1(_DataTableTotMat)
        '_Form1.ShowDialog()
        '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#End Region
        ...
        If _DataTablePartidaEquipmentArg IsNot Nothing Then

            Dim reportDataSource As New ReportDataSource()
            reportDataSource.Name = "ReportPartidaEquipmentArg" ' Nombre de la tabla en report rdlc
            reportDataSource.Value = _DataTablePartidaEquipmentArg
            ...
            'Test~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            'Dim _Form4 As New Form1(_DataTableTESymbolMoney)
            '_Form4.ShowDialog()
        ...
        If _DataTablePartidaEquipmentTotalArg IsNot Nothing Then
            Dim reportDataSource As New ReportDataSource()
            reportDataSource.Name = "PartidaEquipmentTotalArg" ' Nombre de la tabla en report rdlc
            reportDataSource.Value = _DataTablePartidaEquipmentTotalArg
        ...
        If _DataTablePartidaCostsEquitmentTotalArg IsNot Nothing Then
            Dim reportDataSource As New ReportDataSource()
            reportDataSource.Name = "PartidaCostsEquitmentTotalArg" ' Nombre de la tabla en report rdlc
            reportDataSource.Value = _DataTablePartidaCostsEquitmentTotalArg

            ReportViewer1.LocalReport.DataSources.Add(reportDataSource)
        End If

        If _DataTablePartidaCostsEquitmentTbArg IsNot Nothing Then
            Dim reportDataSource As New ReportDataSource()
            reportDataSource.Name = "PartidaCostsEquitmentTbArg" ' Nombre de la tabla en report rdlc
            reportDataSource.Value = _DataTablePartidaCostsEquitmentTbArg

            ReportViewer1.LocalReport.DataSources.Add(reportDataSource)
        End If

        ReportViewer1.LocalReport.ReportEmbeddedResource = "UPAZ.PriceAnalysisArg.rdlc"
