...
Public Class FormEqmtPriceEst4
    ...
    Public Sub New(ByVal EquipmentType_id As Int32, ByVal DisplayType As EnumDisplayType,
        ...
        tlpEquipPer.Controls.Add(_UPlblEquipmentPriceNew, 0, 0)
        tlpEquipPer.Controls.Add(_UPlblEquipmetUsefulLife, 0, 1)
        tlpEquipPer.Controls.Add(_UPlblEquipmentUseTime, 0, 2)
        tlpEquipPer.Controls.Add(_UPlblEquipmentInterestRate, 0, 3)
        tlpEquipPer.Controls.Add(_UPlblEquipmentInsurance, 0, 4)
        tlpEquipPer.Controls.Add(_UPlblEquipmentTax, 0, 5)
        tlpEquipPer.Controls.Add(_UPlblEquipmentCustodyHour, 0, 6)


        tlpEquipPer.Controls.Add(_UPlblEquipmentMajorRepairs, 3, 0)
        tlpEquipPer.Controls.Add(_UPlblEquipmentWorkshopSpareParts, 3, 1)
        tlpEquipPer.Controls.Add(_UPlblEquipmentFuelPrice, 3, 2)
        tlpEquipPer.Controls.Add(_UPlblEquipmetLubricants, 3, 3)
        tlpEquipPer.Controls.Add(_UPlblEquipmentLabor, 3, 4)
        tlpEquipPer.Controls.Add(_UPlblEquipmentWearElements, 3, 5)
        tlpEquipPer.Controls.Add(_UPlblEquipmentTiresHour, 3, 6)


        tlpEquipPer.Controls.Add(_UPNumEquipmentPriceNew, 1, 0)
        tlpEquipPer.Controls.Add(_UPNumEquipmetUsefulLife, 1, 1)
        tlpEquipPer.Controls.Add(_UPNumEquipmentUseTime, 1, 2)
        tlpEquipPer.Controls.Add(_UPNumEquipmentInterestRate, 1, 3)
        tlpEquipPer.Controls.Add(_UPNumEquipmentInsurance, 1, 4)
        tlpEquipPer.Controls.Add(_UPNumEquipmentTax, 1, 5)
        tlpEquipPer.Controls.Add(_UPNumEquipmentCustodyHour, 1, 6)

        tlpEquipPer.Controls.Add(_UPNumEquipmentMajorRepairs, 4, 0)
        tlpEquipPer.Controls.Add(_UPNumEquipmentWorkshopSpareParts, 4, 1)
        tlpEquipPer.Controls.Add(_UPNumEquipmentFuel, 4, 2)
        tlpEquipPer.Controls.Add(_UPNumEquipmetLubricants, 4, 3)
        tlpEquipPer.Controls.Add(_UPNumEquipmentLabor, 4, 4)
        tlpEquipPer.Controls.Add(_UPNumEquipmentWearElements, 4, 5)
        tlpEquipPer.Controls.Add(_UPNumEquipmentTiresHour, 4, 6)

        tlpEqmtPriceEstMT4.Controls.Add(_UPlblTotalOwnershipCost, 0, 0)
        tlpEqmtPriceEstMT4.Controls.Add(_UPlblTotalOperatingCost, 3, 0)
        tlpEqmtPriceEstMT4.Controls.Add(_UPlblTotalHourlyCost, 6, 0)

        tlpEqmtPriceEstMT4.Controls.Add(_UPNumTotalOwnershipCost, 1, 0)
        tlpEqmtPriceEstMT4.Controls.Add(_UPNumTotalOperatingCost, 4, 0)
        tlpEqmtPriceEstMT4.Controls.Add(_UPNumTotalHourlyCost, 7, 0)
    ...
    Private Sub tlpPossCost_Paint(sender As Object, e As PaintEventArgs) Handles tlpEquipPer.Paint

    End Sub

    Private Sub TableLayoutPanel2_Paint(sender As Object, e As PaintEventArgs) Handles tlpEqmtPriceEstMT4.Paint

    End Sub

    Private Sub TableLayoutPanel1_Paint(sender As Object, e As PaintEventArgs) Handles tlpEqmtPriceEstM4.Paint
